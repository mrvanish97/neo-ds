...
---@field primary NeoDs.ColorRef Base background tier.
...
---@field backdrop NeoDs.ColorRef Backdrop behind focused modal or Zen content.
...
---@field disabled NeoDs.ColorRef Disabled foreground token.
...
---@field subtle NeoDs.ColorRef Subtle border token.
...
---@field hover NeoDs.ColorRef Interactive hover background token.
...
---@field link NeoDs.ColorRef Entity-level link token.

---Keyword-family syntax colors.
---@class (exact) NeoDs.SyntaxKeywordPalette
---@field _ NeoDs.ColorRef Default keyword color.
---@field primary NeoDs.ColorRef Default keyword color for control-flow, declarations, and structural tokens.
---@field secondary NeoDs.ColorRef Import, storage, modifier, operator, and qualifier keyword color.
...
---@field palette NeoDs.ThemePalette Complete semantic palette.
